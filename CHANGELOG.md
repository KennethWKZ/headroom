...
* **proxy:** add Claude Code Bedrock-route compatibility shims for /model/{id}/invoke and /invoke-with-response-stream; without --bedrock-api-url these return Anthropic-compatible JSON/SSE responses rather than native AWS Bedrock payloads.
